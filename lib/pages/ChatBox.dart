...
//   @override
//   Widget build(BuildContext context) {
//     final String? sender = Provider.of<UserProvider>(context).uid;
//     final String? receiver = Provider.of<UserProvider>(context).sid;
// if (sender == null || receiver == null) {
//   return Scaffold(
//     appBar: AppBar(title: Text("Chat")),
//     body: Center(child: Text("Invalid sender or receiver")),
//   );
// }
//     return Scaffold(
//       appBar: AppBar(
...
class _ChatBoxState extends State<ChatBox> {
 ...
 Stream<QuerySnapshot> getMessages(String sender, String receiver) {
  ...
  @override
  Widget build(BuildContext context) {
    final String? sender = Provider.of<UserProvider>(context).uid.toString();
    final String? receiver = Provider.of<UserProvider>(context).sid.toString();
    print("=============================================");
    print(sender);
    print(receiver);
    print("=============================================");
